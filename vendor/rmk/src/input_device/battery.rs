...
#[cfg(feature = "_ble")]
use crate::keyboard::KEY_PRESS_SEQUENCE;
...
pub(crate) static BATTERY_UPDATE: Signal<crate::RawMutex, BatteryUpdate> = Signal::new();

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub(crate) struct BatteryUpdate {
    pub(crate) state: BatteryState,
    pub(crate) key_press_sequence: u32,
}
                ...
                #[cfg(feature = "_ble")]
                {
                    if matches!(self.battery_state, BatteryState::Normal(_) | BatteryState::NotAvailable) {
                        ...
                        if self.battery_state != BatteryState::Normal(battery_percent) {
                            ...
                            // Send signal
                            BATTERY_UPDATE.signal(BatteryUpdate {
